...
ZEND_BEGIN_ARG_INFO(cairo_set_font_options_args, ZEND_SEND_BY_VAL)
	ZEND_ARG_OBJ_INFO(0, context, Cairo\\Context, 0)
	ZEND_ARG_OBJ_INFO(0, fontoptions, Cairo\\Font\\Options, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(cairo_set_scaled_font_args, ZEND_SEND_BY_VAL)
	ZEND_ARG_OBJ_INFO(0, context, Cairo\\Context, 0)
	ZEND_ARG_OBJ_INFO(0, scaledfont, Cairo\\Font\\Scaled, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(cairo_solidpattern_args, ZEND_SEND_BY_VAL)
	ZEND_ARG_OBJ_INFO(0, pattern, Cairo\\Pattern\\Solid, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(cairo_surfacepattern_args, ZEND_SEND_BY_VAL)
	ZEND_ARG_OBJ_INFO(0, pattern, Cairo\\Pattern\\Surface, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(cairo_pattern_add_color_stop_rgb_args, ZEND_SEND_BY_VAL)
  ZEND_ARG_OBJ_INFO(0, pattern, Cairo\\Pattern\\Gradient, 0)
  ZEND_ARG_INFO(0, offset)
  ZEND_ARG_INFO(0, red)
  ZEND_ARG_INFO(0, green)
  ZEND_ARG_INFO(0, blue)
...
ZEND_BEGIN_ARG_INFO(cairo_lineargradient_args, ZEND_SEND_BY_VAL)
  ZEND_ARG_OBJ_INFO(0, pattern, Cairo\\Pattern\\Gradient\\Linear, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(cairo_radialgradient_args, ZEND_SEND_BY_VAL)
  ZEND_ARG_OBJ_INFO(0, pattern, Cairo\\Pattern\\Gradient\\Radial, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(cairo_font_options_args, ZEND_SEND_BY_VAL)
	ZEND_ARG_OBJ_INFO(0, options, Cairo\\Font\\Options, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(cairo_font_options_two_args, ZEND_SEND_BY_VAL)
    ZEND_ARG_OBJ_INFO(0, options, Cairo\\Font\\Options, 0)
	ZEND_ARG_OBJ_INFO(0, other, Cairo\\Font\\Options, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(cairo_toy_font_face_args, ZEND_SEND_BY_VAL)
	ZEND_ARG_OBJ_INFO(0, fontface, Cairo\\FontFace\\Toy, 0)
ZEND_END_ARG_INFO()
#endif
...
ZEND_BEGIN_ARG_INFO(cairo_svg_surface_args, ZEND_SEND_BY_VAL)
	ZEND_ARG_OBJ_INFO(0, surface, Cairo\\Surface\\SVG, 0)
...
ZEND_BEGIN_ARG_INFO(cairo_pdf_surface_set_size_args, ZEND_SEND_BY_VAL)
	ZEND_ARG_OBJ_INFO(0, surface, Cairo\\Surface\\PDF, 0)
	ZEND_ARG_INFO(0, width)
	ZEND_ARG_INFO(0, height)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(cairo_ps_surface_args, ZEND_SEND_BY_VAL)
	ZEND_ARG_OBJ_INFO(0, surface, Cairo\\Surface\\PS, 0)
ZEND_END_ARG_INFO()
