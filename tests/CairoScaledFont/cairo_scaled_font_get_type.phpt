...
CAUGHT ERROR: Argument 1 passed to cairo_scaled_font_get_type() must be an instance of Cairo\Font\Scaled, integer given

Warning: cairo_scaled_font_get_type() expects parameter 1 to be Cairo\Font\Scaled, integer given in %s on line %d
