...
CAUGHT ERROR: Argument 1 passed to cairo_pattern_create_for_surface() must be an instance of Cairo\Surface, integer given

Warning: cairo_pattern_create_for_surface() expects parameter 1 to be Cairo\Surface, integer given in %s on line %d