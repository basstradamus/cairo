...
int(0)
int(1)
CAUGHT ERROR: Argument 1 passed to cairo_toy_font_face_get_weight() must be an instance of Cairo\FontFace\Toy, instance of stdClass given

Warning: cairo_toy_font_face_get_weight() expects parameter 1 to be Cairo\FontFace\Toy, object given in %s on line %d
NULL
CAUGHT ERROR: Argument 1 passed to cairo_toy_font_face_get_weight() must be an instance of Cairo\FontFace\Toy, string given

Warning: cairo_toy_font_face_get_weight() expects parameter 1 to be Cairo\FontFace\Toy, string given in %s on line %d
NULL
