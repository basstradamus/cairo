...
CAUGHT ERROR: Argument 1 passed to cairo_surface_flush() must be an instance of Cairo\Surface, integer given

Warning: cairo_surface_flush() expects parameter 1 to be Cairo\Surface, integer given in %s on line %d