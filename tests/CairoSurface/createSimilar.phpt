...
$newsurface = $surface->createSimilar(Cairo\Content::COLOR, 10, 10);
var_dump($newsurface);
...
/* Wrong number args - 2 */
try {
    $surface->createSimilar(Cairo\Content::COLOR);
    trigger_error('We should bomb here');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
...
/* Wrong number args - 3 */
try {
    $surface->createSimilar(Cairo\Content::COLOR, 10);
    trigger_error('We should bomb here');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
...
/* Wrong number args - 4 */
try {
    $surface->createSimilar(Cairo\Content::COLOR, 10, 10, 10);
    trigger_error('We should bomb here');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
...
/* Wrong arg type 2 */
try {
    $surface->createSimilar(Cairo\Content::COLOR, array(), 10);
    trigger_error('We should bomb here');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
...
/* Wrong arg type 3 */
try {
    $surface->createSimilar(Cairo\Content::COLOR, 10, array());
    trigger_error('We should bomb here');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
