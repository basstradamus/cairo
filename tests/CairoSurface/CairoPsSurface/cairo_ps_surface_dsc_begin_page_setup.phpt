...
CAUGHT ERROR: Argument 1 passed to cairo_ps_surface_dsc_begin_page_setup() must be an instance of Cairo\Surface\PS, null given

Warning: cairo_ps_surface_dsc_begin_page_setup() expects parameter 1 to be Cairo\Surface\PS, null given in %s on line %d