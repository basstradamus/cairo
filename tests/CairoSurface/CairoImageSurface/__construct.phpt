...
/* Wrong number args - 2 */
try {
    new Cairo\Surface\Image(Cairo\Format::ARGB32);
    trigger_error('We should bomb here');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
...
/* Wrong number args - 3 */
try {
    new Cairo\Surface\Image(Cairo\Format::ARGB32, 1);
    trigger_error('We should bomb here');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
...
/* Wrong number args - 4 */
try {
    new Cairo\Surface\Image(Cairo\Format::ARGB32, 1, 1, 1);
    trigger_error('We should bomb here');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
...
/* Wrong arg type 2 */
try {
    new Cairo\Surface\Image(Cairo\Format::ARGB32, array(), 1);
    trigger_error('We should bomb here');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
...
/* Wrong arg type 3 */
try {
    new Cairo\Surface\Image(Cairo\Format::ARGB32, 1, array());
    trigger_error('We should bomb here');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
