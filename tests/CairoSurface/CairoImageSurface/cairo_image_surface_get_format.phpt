...
CAUGHT ERROR: Argument 1 passed to cairo_image_surface_get_format() must be an instance of Cairo\Surface\Image, null given

Warning: cairo_image_surface_get_format() expects parameter 1 to be Cairo\Surface\Image, null given in %s on line %d