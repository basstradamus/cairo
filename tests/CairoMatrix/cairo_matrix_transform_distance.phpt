...
CAUGHT ERROR: Argument 1 passed to cairo_matrix_transform_distance() must be an instance of Cairo\Matrix, integer given

Warning: cairo_matrix_transform_distance() expects parameter 1 to be Cairo\Matrix, integer given in %s on line %d
