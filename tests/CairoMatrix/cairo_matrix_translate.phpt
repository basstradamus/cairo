...
CAUGHT ERROR: Argument 1 passed to cairo_matrix_translate() must be an instance of Cairo\Matrix, integer given

Warning: cairo_matrix_translate() expects parameter 1 to be Cairo\Matrix, integer given in %s on line %d
