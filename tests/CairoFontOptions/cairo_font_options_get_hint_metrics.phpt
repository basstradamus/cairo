...
CAUGHT ERROR: Argument 1 passed to cairo_font_options_get_hint_metrics() must be an instance of Cairo\Font\Options, integer given

Warning: cairo_font_options_get_hint_metrics() expects parameter 1 to be Cairo\Font\Options, integer given in %s on line %d