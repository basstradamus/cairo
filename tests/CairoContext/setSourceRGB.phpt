...
Cairo\Context::setSourceRGB() expects parameter 1 to be double, array given
Cairo\Context::setSourceRGB() expects parameter 2 to be double, array given
Cairo\Context::setSourceRGB() expects parameter 3 to be double, array given