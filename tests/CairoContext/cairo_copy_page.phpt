...
CAUGHT ERROR: Argument 1 passed to cairo_copy_page() must be an instance of Cairo\Context, integer given

Warning: cairo_copy_page() expects parameter 1 to be Cairo\Context, integer given in %s on line %d