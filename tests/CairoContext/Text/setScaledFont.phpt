...
$orig_options = new Cairo\Font\Options();
...
try {
    ...
    trigger_error('setScaledFont requires instanceof Cairo\Font\Scaled');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
...
Cairo\Context::setScaledFont() expects parameter 1 to be Cairo\Font\Scaled, integer given