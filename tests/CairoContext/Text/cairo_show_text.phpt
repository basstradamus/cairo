...
CAUGHT ERROR: Argument 1 passed to cairo_show_text() must be an instance of Cairo\Context, array given

Warning: cairo_show_text() expects parameter 1 to be Cairo\Context, array given in %s on line %d
