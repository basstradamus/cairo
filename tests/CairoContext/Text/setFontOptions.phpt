...
try {
    ...
    trigger_error('setFontOptions requires instanceof Cairo\Font\Options');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
...
Cairo\Context::setFontOptions() expects parameter 1 to be Cairo\Font\Options, integer given