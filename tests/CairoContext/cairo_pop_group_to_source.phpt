...
CAUGHT ERROR: Argument 1 passed to cairo_pop_group_to_source() must be an instance of Cairo\Context, integer given

Warning: cairo_pop_group_to_source() expects parameter 1 to be Cairo\Context, integer given in %s on line %d