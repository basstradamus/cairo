...
CAUGHT ERROR: Argument 1 passed to cairo_set_line_cap() must be an instance of Cairo\Context, integer given

Warning: cairo_set_line_cap() expects parameter 1 to be Cairo\Context, integer given in %s on line %d
