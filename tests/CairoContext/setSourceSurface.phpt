...
try {
    ...
    trigger_error('setSourceSurface expects instanceof Cairo\Pattern');
} catch (Cairo\Exception $e) {
    echo $e->getMessage(), PHP_EOL;
}
...
Cairo\Context::setSourceSurface() expects parameter 2 to be double, array given
Cairo\Context::setSourceSurface() expects parameter 3 to be double, array given
