...
CAUGHT ERROR: Argument 1 passed to cairo_push_group() must be an instance of Cairo\Context, integer given

Warning: cairo_push_group() expects parameter 1 to be Cairo\Context, integer given in %s on line %d