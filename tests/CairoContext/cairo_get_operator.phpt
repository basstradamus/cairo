...
CAUGHT ERROR: Argument 1 passed to cairo_get_operator() must be an instance of Cairo\Context, integer given

Warning: cairo_get_operator() expects parameter 1 to be Cairo\Context, integer given in %s on line %d