...
Cairo\Context::rectangle() expects parameter 1 to be double, array given
Cairo\Context::rectangle() expects parameter 2 to be double, array given
Cairo\Context::rectangle() expects parameter 3 to be double, array given
Cairo\Context::rectangle() expects parameter 4 to be double, array given