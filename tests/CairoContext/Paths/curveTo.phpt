...
Cairo\Context::curveTo() expects parameter 1 to be double, array given
Cairo\Context::curveTo() expects parameter 2 to be double, array given
Cairo\Context::curveTo() expects parameter 3 to be double, array given
Cairo\Context::curveTo() expects parameter 4 to be double, array given
Cairo\Context::curveTo() expects parameter 5 to be double, array given
Cairo\Context::curveTo() expects parameter 6 to be double, array given