...
cairo_move_to($context, 1);
cairo_move_to($context, 1, 1, 1);

/* wrong types */
cairo_move_to(1, 1, 1);
cairo_move_to($context, array(), 1);
...
Warning: cairo_move_to() expects exactly 3 parameters, 1 given in %s on line %d
...
Warning: cairo_move_to() expects parameter 3 to be double, array given in %s on line %d