...
CAUGHT ERROR: Argument 1 passed to cairo_new_path() must be an instance of Cairo\Context, integer given

Warning: cairo_new_path() expects parameter 1 to be Cairo\Context, integer given in %s on line %d