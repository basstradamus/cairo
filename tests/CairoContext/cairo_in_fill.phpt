...
CAUGHT ERROR: Argument 1 passed to cairo_in_fill() must be an instance of Cairo\Context, integer given

Warning: cairo_in_fill() expects parameter 1 to be Cairo\Context, integer given in %s on line %d
