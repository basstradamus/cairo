...
CAUGHT ERROR: Argument 1 passed to cairo_fill_preserve() must be an instance of Cairo\Context, integer given

Warning: cairo_fill_preserve() expects parameter 1 to be Cairo\Context, integer given in %s on line %d