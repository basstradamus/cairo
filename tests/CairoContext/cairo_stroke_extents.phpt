...
CAUGHT ERROR: Argument 1 passed to cairo_stroke_extents() must be an instance of Cairo\Context, integer given

Warning: cairo_stroke_extents() expects parameter 1 to be Cairo\Context, integer given in %s on line %d