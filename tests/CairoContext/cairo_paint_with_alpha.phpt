...
CAUGHT ERROR: Argument 1 passed to cairo_paint_with_alpha() must be an instance of Cairo\Context, integer given

Warning: cairo_paint_with_alpha() expects parameter 1 to be Cairo\Context, integer given in %s on line %d
