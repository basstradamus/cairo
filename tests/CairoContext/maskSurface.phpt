...
$surface2 = new Cairo\Surface\Image(Cairo\Format::ARGB32, 50, 50);
var_dump($surface2);
...
Cairo\Context::maskSurface() expects parameter 2 to be double, array given
Cairo\Context::maskSurface() expects parameter 3 to be double, array given