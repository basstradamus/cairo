...
CAUGHT ERROR: Argument 1 passed to cairo_set_source_rgba() must be an instance of Cairo\Context, array given

Warning: cairo_set_source_rgba() expects parameter 1 to be Cairo\Context, array given in %s on line %d
