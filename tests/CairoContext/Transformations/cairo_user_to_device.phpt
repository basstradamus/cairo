...
CAUGHT ERROR: Argument 1 passed to cairo_user_to_device() must be an instance of Cairo\Context, integer given

Warning: cairo_user_to_device() expects parameter 1 to be Cairo\Context, integer given in %s on line %d
