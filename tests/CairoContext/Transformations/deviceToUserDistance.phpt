...
Cairo\Context::deviceToUserDistance() expects parameter 1 to be double, array given
Cairo\Context::deviceToUserDistance() expects parameter 2 to be double, array given