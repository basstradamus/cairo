...
Cairo\Context::userToDeviceDistance() expects parameter 1 to be double, array given
Cairo\Context::userToDeviceDistance() expects parameter 2 to be double, array given