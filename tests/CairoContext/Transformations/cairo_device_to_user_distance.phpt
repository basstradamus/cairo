...
var_dump(cairo_device_to_user_distance($context, 5, 5));
...
cairo_device_to_user_distance($context);
cairo_device_to_user_distance($context, 1);
cairo_device_to_user_distance($context, 1, 1, 1);

// check arg types, should be context object, double double
cairo_device_to_user_distance(1, 1, 1);
cairo_device_to_user_distance($context, array(), 1);
...
Warning: cairo_device_to_user_distance() expects exactly 3 parameters, 0 given in %s on line %d

Warning: cairo_device_to_user_distance() expects exactly 3 parameters, 1 given in %s on line %d
...
Warning: cairo_device_to_user_distance() expects parameter 3 to be double, array given in %s on line %d